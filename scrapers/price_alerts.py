...
T=os.environ.get("TELEGRAM_TOKEN",""); C=os.environ.get("TELEGRAM_CHAT_ID","")
msg=(
    "\U0001f514 <b>שינויי מחירים השבוע \u2014 כרמיאל</b>\n\U0001f4c5 09.06.2026\n\n"
    "\U0001f4c8 <b>עלו (2 מוצרים):</b>\n"
...
data=urllib.parse.urlencode({"chat_id":C,"text":msg,"parse_mode":"HTML"}).encode()
...
open("output/prices.json","w").write('{"updated":"demo","chains":{"tivtaam":{"name":"\u05d8\u05d9\u05d1","store_id":"010","categories":{}},"keshet":{"name":"\u05e7\u05e9\u05ea","store_id":"015","categories":{}}}}')
