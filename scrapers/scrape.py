...
CATEGORY_RULES = [
    ("הודו", {
        ...
        "not": ["פסטרמה","פסטירמה","נקניק","סלמי","קורנביף","קבנוס","בוזנינה"],
    }),
    ("בקר", {
        "any": ["בקר","עגל","אנטריקוט","אסאדו","אנטרקוט","סינטה","פיקניה","שייטל","פילה בקר",
                ...
                "שפונדרה"],
        "not": ["הודו","עוף","חזיר","גבינ","קממבר","קממברט","מוצרלה","גאודה","פטה","ברי ","שמנת",
                "פסטרמה","פסטירמה","בסטורמה","נקניק","סלמי","פריזר","פפרוני","קסלר","בוזנינה"],
    }),
    ("פסטרמות", {
        "any": ["פסטרמה","פסטירמה","בסטורמה","קורנביף","רוסטביף","בייקון","בקון","שינקן","שינקה",
                "קסטיצה","קוסטיצה","בריסקט","קוטלט שינקן","קוטלט מעושן","בוזנינה"],
        "not": [],
    }),
    ("נקניקיות", {
...
# עקיפות ספציפיות לפי תת-מחרוזת בשם. נבדקות ראשונות וגוברות על הכל.
# None = להסיר מהכלי לגמרי. אחרת = שם הקטגוריה הנכונה.
OVERRIDES = [
    # מקרים תלויי-הקשר שתוקנו ידנית ע"י המשתמש
    ("סינטה לבנה מעושנת", "נקניקים"),
    ("סינטה לבן טרי",     "בשר לבן"),
    ("טחון בקר+לבן",      "בשר לבן"),
    ("בק בייקון",         "נקניקים"),   # בק בייקון = נקניק
    ("לשון בקר בגל",      "פסטרמות"),
    ("לשון בקר מבושל",    "פסטרמות"),
    ("אמסטרדם חי",        "נקניקים"),
    ("אולד אמסטרדם",      "גבינות"),    # גבינה
    ("פרושוטו",           "בשר לבן"),    # פרושוטו = בשר חזיר מיובש -> בשר לבן (להוציא מבקר)
    ("רגל עגל",           None),
    ("סרדלקה",            None),
    ("סרדלקי",            None),
    ("טבעות עגל",         None),
...
def categorize(name):
    ...
    for b in BLACKLIST:
        if b in low:
            return None
    # עקיפות ספציפיות גוברות
    for sub, target in OVERRIDES:
        if sub in n:
            return target  # יכול להיות None (הסרה) או שם קטגוריה
